...
void DesStatePublisher::Lidar_callback(const std_msgs::Bool& alarm_msg){
    ROS_WARN("Lidar estop!!");
...
void DesStatePublisher::initializePublishers() {
    ...
    lidar_subscriber = nh_.subscribe("lidar_alarm",1, &DesStatePublisher::Lidar_callback, this);
}
